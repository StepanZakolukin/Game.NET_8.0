...
namespace Shooter
{
    public partial class MyForm : Form
    {
        ...
        void DrawTheStartOfTheLevel(object sender, PaintEventArgs e)
        {
            ...
            graphics.DrawString(" ÎËÍÌËÚÂ ÔÓ ˝Í‡ÌÛ, ˜ÚÓ·˚ Ì‡˜‡Ú¸ Ë„Û.", new Font("Courier New", Math.Max(sizeOfTheGridCell / 2, 1)), Brushes.LightGoldenrodYellow, new RectangleF(
        ...
        void DrawTheResultsWindow(object sender, PaintEventArgs e)
        {
            ...
            DrawTheText(graphics, String.Format("{0, -6} {1, 9}", "—˜∏Ú", model.NumberOfBotsDestroyed).Replace(' ', '.'),
